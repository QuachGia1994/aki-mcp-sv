...
- [x] Switched away from token-in-URL after hitting the real DCR bug testing against claude.ai — see `docs/research/claude-ai-oauth-connector.md`
...
- `docs/research/claude-ai-oauth-connector.md` — research behind the switch to OAuth, dates and sources
