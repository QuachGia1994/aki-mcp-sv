...
- `docs/ref/postman-pool-autojoin.md` — Telegram allowlist, invite handling, LibreWolf clone or dedicated Chrome/CDP browser boundary, manual Human Verify checkpoint, and join/report behavior
