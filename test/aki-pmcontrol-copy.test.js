...
assert.match(mcpSrc, /function folderPickerIntent/);
assert.match(mcpSrc, /function installFolderPickerGuard/);
assert.match(mcpSrc, /showDirectoryPicker/);
assert.match(mcpSrc, /HTMLInputElement\.prototype\.showPicker/);
assert.match(mcpSrc, /opening folder picker/);
