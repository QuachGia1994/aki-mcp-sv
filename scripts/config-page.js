...
<div class="checks" id="customPromptLocks">
  ...
  <label><input type="checkbox" id="nativeVisualTools" checked disabled> Aki Skills: Browser/ImageGen + Ponytail/Anti-Vibe + Mobile Native + Icon Silhouette + Strix 🔒 custom</label>
</div>
